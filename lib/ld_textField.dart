...
class KTextField extends StatelessWidget {
  ...
  Color placeholderColor; /// 提示文本颜色
  double fontSize;        /// 文字大小
  FontWeight fontWeight;  /// 文本字体宽度
  List<TextInputFormatter> inputFormatters;   /// 输入文本格式化
  ...
  double borderRadiusTL; /// 边框左上圆角
  double borderRadiusTR; /// 边框右上圆角
  double borderRadiusBL; /// 边框左下圆角
  double borderRadiusBR; /// 边框右下圆角
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: enableInputBorderWidget ?? OutlineInputBorder(
          borderSide: BorderSide(
            color: enabledBorder,
            width: borderWidth,
          ),
          borderRadius: borderRadius == null ? BorderRadius.only(
          ...
          ) : BorderRadius.all(Radius.circular(borderRadius ?? Radius.zero)),
        ),
        disabledBorder: disabledInputBorderWidget ?? OutlineInputBorder(
          borderSide: BorderSide(
        ...
        focusedBorder: focusedInputBorderWidget ?? OutlineInputBorder(
          borderSide: BorderSide(
